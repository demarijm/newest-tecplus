...
export const caseStudy = {
  client: 'Shopify',
  title: 'Learn to grow in Spaces',
  description:
    'The spaces team of Shopify is FamilyFund is a crowdfunding platform for friends and family. Allowing users to take personal loans from their network without a traditional financial institution.',
  summary: [
